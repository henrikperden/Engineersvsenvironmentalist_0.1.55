...
{
 {
    type = "item",
    name = "empty-barrel",
    icon = "__Engineersvsenvironmentalist__/graphics/icons/fluid-logistics/empty-barrel.png",
  ...
  },
  {
    ...
    icon = "__Engineersvsenvironmentalist__/graphics/icons/fluid-logistics/crude-oil-barrel.png",
    flags = {"goes-to-main-inventory"},
    subgroup = "fluid-logistics",
    order = "f-a-2]",
    stack_size = 10
